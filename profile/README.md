...
| Agent Skills | [`crawlora-skills@1.14.0`](https://github.com/Crawlora-org/crawlora-skills) | REST-based catalog and focused research skills |
...
skill plus 77 focused skills, including `google-maps-research`,
`local-business-prospecting`, `influencer-discovery`,
`journalist-media-research`, and `tiktok-ad-research`. Install one (or all) into
