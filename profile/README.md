...
| --- | --- | --- |
| Go | [`crawlora-go-sdk`](https://github.com/Crawlora-org/crawlora-go-sdk) | `latest` for current SDK version `v1.18.0-sdk.1` |
| TypeScript / JavaScript | [`crawlora-typescript-sdk`](https://github.com/Crawlora-org/crawlora-typescript-sdk) | `latest` for current SDK version `v1.18.0-sdk.1` / `@crawlora-org/sdk@1.18.0-sdk.1` on npm |
...
For reproducible installs, pin `v1.18.0-sdk.1` for Git-based SDKs and
`@crawlora-org/sdk@1.18.0-sdk.1` for TypeScript.
