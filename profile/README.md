...
| --- | --- | --- |
| Public SDK contract | `v1.33.0-sdk.1` | 947 generated operations across Go, TypeScript/JavaScript, Python, Ruby, Java, and PHP |
| Hosted MCP | [`crawlora-mcp@1.12.0`](https://www.npmjs.com/package/crawlora-mcp) | 893 tools across 81 platform groups |
...
| --- | --- | --- |
| Go | [`crawlora-go-sdk`](https://github.com/Crawlora-org/crawlora-go-sdk) | `latest` for current SDK version `v1.33.0-sdk.1` |
| TypeScript / JavaScript | [`crawlora-typescript-sdk`](https://github.com/Crawlora-org/crawlora-typescript-sdk) | `latest` for current SDK version `v1.33.0-sdk.1` / `@crawlora-org/sdk@1.33.0-sdk.1` on npm |
...
| Ruby | [`crawlora-ruby-sdk`](https://github.com/Crawlora-org/crawlora-ruby-sdk) | `v1.33.0-sdk.1` / `latest` — gem [`crawlora`](https://rubygems.org/gems/crawlora) on RubyGems (and GitHub Packages) |
| Java / JVM | [`crawlora-java-sdk`](https://github.com/Crawlora-org/crawlora-java-sdk) | `v1.33.0-sdk.1` / `latest` — [`net.crawlora:crawlora-sdk`](https://central.sonatype.com/artifact/net.crawlora/crawlora-sdk) on Maven Central (and GitHub Packages) |
| PHP | [`crawlora-php-sdk`](https://github.com/Crawlora-org/crawlora-php-sdk) | `v1.33.0-beta.1` — [`crawlora/sdk`](https://packagist.org/packages/crawlora/sdk) on Packagist (`^1.33@beta`) |
...
For reproducible installs, pin `v1.33.0-sdk.1` for Git-based SDKs and
`@crawlora-org/sdk@1.33.0-sdk.1` for TypeScript.
...
composer require crawlora/sdk:^1.33@beta
```
...
`@crawlora-org/sdk`. Python is published to PyPI as `crawlora` (a `1.33.0.dev1`
...
`https://mcp.crawlora.net/mcp` exposes the public API as 893 MCP tools using
stable `family.action` names.

| Integration | Repository | What it is |
| --- | --- | --- |
| MCP server | [`crawlora-mcp`](https://github.com/Crawlora-org/crawlora-mcp) | Version `1.12.0`. Hosted (and local stdio) Model Context Protocol server exposing the public API as 893 MCP tools. Connect any MCP client to `https://mcp.crawlora.net/mcp`. |
